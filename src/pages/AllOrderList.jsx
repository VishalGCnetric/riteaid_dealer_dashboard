...
import { fetchAllOrders, selectError, selectLoading } from '../slices/neworderSlice'; // Import the action
...
const loading = useSelector(selectLoading);
  ...
  // }
  return (
    <OrderList Heading="All Orders" show={false} customerOrders={allOrders} />
  );
};
